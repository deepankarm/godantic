...
func TestMarshalPartial_Basic(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result, state, _ := validator.MarshalPartial([]byte(tt.input))
...
func TestMarshalPartial_Pointers(t *testing.T) {
	...
	t.Run("truncated_pointer", func(t *testing.T) {
		result, state, _ := validator.MarshalPartial([]byte(`{"name": "Jo`))
		if result == nil {
			t.Fatal("expected result")
		}
	...
	t.Run("nil_pointer", func(t *testing.T) {
		result, _, _ := validator.MarshalPartial([]byte(`{"age": 30}`))
		if result == nil {
			t.Fatal("expected result")
		}
		if result.Name != nil {
	...
	t.Run("complete_pointers", func(t *testing.T) {
		result, state, errs := validator.MarshalPartial([]byte(`{"name": "John", "age": 30}`))
		if result == nil {
			t.Fatal("expected result")
		}
...
func TestMarshalPartial_Slices(t *testing.T) {
	...
	t.Run("truncated_slice_element", func(t *testing.T) {
		result, state, _ := validator.MarshalPartial([]byte(`{"name": "John", "tags": ["tag1", "tag`))
		if result == nil {
			t.Fatal("expected result")
		}
		if result.Name != "John" {
	...
	t.Run("truncated_int_slice", func(t *testing.T) {
		result, _, _ := validator.MarshalPartial([]byte(`{"name": "John", "ids": [1, 2,`))
		if result == nil {
			t.Fatal("expected result")
		}
		if len(result.IDs) != 2 {
	...
	t.Run("complete_slices", func(t *testing.T) {
		result, state, errs := validator.MarshalPartial([]byte(`{"name": "John", "tags": ["a", "b"], "ids": [1, 2, 3]}`))
		if result == nil {
			t.Fatal("expected result")
		}
	...
	t.Run("truncated_struct_in_slice", func(t *testing.T) {
		result, state, _ := validator.MarshalPartial([]byte(`{"name": "John", "items": [{"id": 1, "name": "Item1"}, {"id": 2, "name": "Ite`))
		if result == nil {
			t.Fatal("expected result")
		}
...
func TestMarshalPartial_Maps(t *testing.T) {
	...
	t.Run("truncated_map_key", func(t *testing.T) {
		result, state, _ := validator.MarshalPartial([]byte(`{"name": "John", "metadata": {"ke`))
		if result == nil {
			t.Fatal("expected result")
		}
		if result.Name != "John" {
	...
	t.Run("truncated_map_value", func(t *testing.T) {
		result, state, _ := validator.MarshalPartial([]byte(`{"name": "John", "metadata": {"key": "valu`))
		if result == nil {
			t.Fatal("expected result")
		}
	...
	t.Run("complete_maps", func(t *testing.T) {
		result, state, errs := validator.MarshalPartial([]byte(`{"name": "John", "metadata": {"key": "value"}, "scores": {"math": 95}}`))
		if result == nil {
			t.Fatal("expected result")
		}
...
func TestMarshalPartial_MapWithNestedStruct(t *testing.T) {
	...
	t.Run("truncated", func(t *testing.T) {
		result, state, _ := validator.MarshalPartial([]byte(`{"settings": {"key1": {"value": "tes`))
		if result == nil {
			t.Fatal("expected result")
		}
	...
	t.Run("complete", func(t *testing.T) {
		result, state, errs := validator.MarshalPartial([]byte(`{"settings": {"key1": {"value": "test", "count": 42}}}`))
		if result == nil {
			t.Fatal("expected result")
		}
...
func TestMarshalPartial_Union(t *testing.T) {
	...
	t.Run("partial_discriminator", func(t *testing.T) {
		_, state, _ := validator.MarshalPartial([]byte(`{"species": "do`))
		if state.IsComplete {
			t.Error("expected incomplete")
		}
	...
	t.Run("complete_discriminator_partial_field", func(t *testing.T) {
		result, state, _ := validator.MarshalPartial([]byte(`{"species": "dog", "name": "Bu`))
		if result == nil {
			t.Fatal("expected result")
		}
		dog, ok := (*result).(*TDog)
	...
	t.Run("complete", func(t *testing.T) {
		result, state, errs := validator.MarshalPartial([]byte(`{"species": "dog", "name": "Buddy", "breed": "Golden", "is_good": true}`))
		if result == nil {
			t.Fatal("expected result")
		}
		dog, ok := (*result).(*TDog)
	...
	t.Run("missing_discriminator", func(t *testing.T) {
		_, state, errs := validator.MarshalPartial([]byte(`{"name": "Bu`))
		if state.IsComplete {
			t.Error("expected incomplete")
		}
...
func TestMarshalPartial_UnionArray(t *testing.T) {
	...
	t.Run("truncated_element", func(t *testing.T) {
		result, state, _ := validator.MarshalPartial([]byte(`{"animals": [{"type": "dog", "name": "Re`))
		if result == nil {
			t.Fatal("expected result")
		}
	...
	t.Run("complete", func(t *testing.T) {
		result, state, errs := validator.MarshalPartial([]byte(`{"animals": [{"type": "dog", "name": "Rex"}, {"type": "cat", "name": "Fluffy"}]}`))
		if result == nil {
			t.Fatal("expected result")
		}
...
func TestMarshalPartial_NestedUnion(t *testing.T) {
	...
	t.Run("truncated_nested", func(t *testing.T) {
		result, state, _ := validator.MarshalPartial([]byte(`{"type": "dog", "name": "Rex", "details": {"type": "ca`))
		if result == nil {
			t.Fatal("expected result")
		}
		if result.Type != "dog" {
	...
	t.Run("complete_nested", func(t *testing.T) {
		result, state, errs := validator.MarshalPartial([]byte(`{"type": "dog", "name": "Rex", "details": {"type": "cat", "name": "Fluffy"}}`))
		if result == nil {
			t.Fatal("expected result")
		}
...
func TestMarshalPartial_CustomTaggedUnion(t *testing.T) {
	...
	t.Run("truncated_custom_tag", func(t *testing.T) {
		result, state, _ := validator.MarshalPartial([]byte(`{"animal_type": "do`))
		if result == nil {
			t.Fatal("expected result")
		}
		if state.IsComplete {
	...
	t.Run("complete_custom_tag", func(t *testing.T) {
		result, state, errs := validator.MarshalPartial([]byte(`{"animal_type": "dog", "name": "Rex"}`))
		if result == nil {
			t.Fatal("expected result")
		}
...
func TestPartialState_WaitingFor(t *testing.T) {
	validator := godantic.NewValidator[TUser]()
	_, state, _ := validator.MarshalPartial([]byte(`{"name": "John", "age":`))
